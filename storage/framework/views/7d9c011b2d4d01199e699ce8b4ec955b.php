    ...
    <table id="miTabla" class="table table-responsive table-hover">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr id="cliente_<?php echo e($cliente->id_cliente); ?>">
                    <td><?php echo e($cliente->id_cliente); ?></td>
                    <td>
                        <?php if($cliente->imagen): ?>
                            <img src="<?php echo e(asset('imgCliente/' . $cliente->imagen)); ?>" width="50">
                        <?php else: ?>
                            <img src="<?php echo e(asset('imgCliente/user_default.png')); ?>" width="50">
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($cliente->nombre_cliente); ?></td>
                    <td><?php echo e($cliente->nombre_comercial); ?></td>
                    <td><?php echo e($cliente->rol); ?></td>
                    ...
                    <td data-id="<?php echo e($cliente->id_estado); ?>"><?php echo e($cliente->Estado); ?></td>
                    <td data-id="<?php echo e($cliente->id_municipio); ?>"><?php echo e($cliente->Municipio); ?></td>
                    ...
                    <td class=" row justify-content-center">
                        <ul class="opciones">
                            ...
                            <li>
                                <a title="Eliminar Cliente" href="#" class="btn btn-danger btn-eliminar" data-tipo="cliente" data-id="<?php echo e($cliente->id_cliente); ?>">
...
<div class="modal fade" id="crearClienteModal" tabindex="-1" aria-labelledby="crearClienteLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <form method="POST" action="<?php echo e(route('cliente.crear')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-12">
                ...
                <select class="form-select" name="rol" id="editar_rol" required>
                  <option value="Cliente" <?php echo e($cliente->rol == 'Cliente' ? 'selected' : ''); ?>>Cliente</option>
                  <option value="Prospecto" <?php echo e($cliente->rol == 'Prospecto' ? 'selected' : ''); ?>>Prospecto</option>
                  <option value="Proveedor" <?php echo e($cliente->rol == 'Proveedor' ? 'selected' : ''); ?>>Proveedor</option>
                </select>
              </div>
            </div>
          </div>
